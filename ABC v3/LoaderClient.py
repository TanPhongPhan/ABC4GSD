...
#	procs.append( subprocess.Popen(["python", os.path.join(directory,"Queue.py"), "tcp://localhost:5551", "tcp://*:5561"]) )
	...
	# procs.append( subprocess.Popen(["python", os.path.join(directory,"Forwarder.py"), "tcp://success1.ict.swin.edu.au:5550", "tcp://*:5560"]) )
	# procs.append( subprocess.Popen(["python", os.path.join(directory,"Queue.py"), "tcp://success1.ict.swin.edu.au:5551", "tcp://*:5561"]) )
